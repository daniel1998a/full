        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="id" name="id" aria-describedy="emailHelp" value="{{ isset($estudiante->id)?$estudiante->id:" "}}" placeholder="Id estudiante" {{isset($estudiante->id)?"readnoly":""}}>
        </div>

        <div class="form-group">
            <label for="apellidos">Apellidos</label>
            <input type="text" class="form-control" id="apellidos" name="apellidos" 
            value="{{isset($estudiante->apellidos)?$estudiante->apellidos:" "}}" placeholder="Apellidos">
        </div>
